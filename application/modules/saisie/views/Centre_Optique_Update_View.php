    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modification d'un Centre Optique</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
         ...
         <div class="card-body">
               <form id="FormData" action="<?php echo base_url()?>saisie/Centre_Optique/update" method="POST">
              <input type="hidden" name="ID_CENTRE_OPTIQUE" class="form-control" value="<?php echo $selected['ID_CENTRE_OPTIQUE']?>" id="ID_CENTRE_OPTIQUE">
                      <div class="row">
