    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modification d'une structure sanitaire</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
         ...
         <div class="card-body">
               <form id="FormData" action="<?php echo base_url()?>saisie/Structure_Sanitaire/update" method="POST">
              <input type="hidden" name="ID_STRUCTURE" class="form-control" value="<?php echo $selected['ID_STRUCTURE']?>" id="ID_STRUCTURE">
                      <div class="row">
                         <div class="form-group col-md-6">
                          <label for="DESCRIPTION">
                             Nom du structure sanitaire
                  ...
                  <div class="form-group col-md-6">
                          ...
                          foreach ($type_str as $key => $value) {
                            if ($value['ID_TYPE_STRUCTURE'] == $selected['ID_TYPE_STRUCTURE']) {
                              ?>
                          <option value="<?=$value['ID_TYPE_STRUCTURE']?>" selected="selected"><?=$value['DESCRIPTION']?></option>
                              <?php
                            }
                            else{
                              ?>
