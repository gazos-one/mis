          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modification d'un medicament</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

         <div class="card-body">
               <form id="FormData" action="<?php echo base_url()?>saisie/Medicament/update" method="POST">
                <input type="hidden" name="ID_MEDICAMENT" class="form-control" value="<?php echo $selected['ID_MEDICAMENT'] ?>" id="ID_MEDICAMENT">
                      <div class="row">
                  ...
                  <div class="form-group col-md-6">
                          ...
                          foreach ($type_med as $key => $value) {
                            if ($value['ID_COUVERTURE_MEDICAMENT']== $selected['ID_COUVERTURE_MEDICAMENT']) {
                              ?>
                          <option value="<?=$value['ID_COUVERTURE_MEDICAMENT']?>" selected="selected" ><?=$value['DESCRIPTION']?></option>
                              <?php
                            }
                            else{
                              ?>
