    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
         ...
         <div class="card-body">
               <form id="FormData" action="<?php echo base_url()?>saisie/Pharmacie/update" method="POST">
              <input type="hidden" name="ID_PHARMACIE" class="form-control" value="<?php echo $selected['ID_PHARMACIE']?>" id="ID_PHARMACIE">
                      <div class="row">
