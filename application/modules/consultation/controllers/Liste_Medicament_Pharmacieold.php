      ...
      foreach ($resultat as $key) 
         {
          ...
          foreach ($listes as $value) {
            ...
            $tableliste .= "<tr>
            <td>".$value['ANOM']." ".$value['APRENOM']."</td>
            <td>".$value['NOM']." ".$value['PRENOM']."</td>
            <td>".$value['DESCRIPTION']."</td>
            <td>".date("d-m-Y", strtotime($value['DATE_CONSULTATION']))."</td>
            <td>".$value['NUM_BORDERAUX']."</td>
            <td class='text-right'>".number_format($value['QUANTITE'],0,","," ")."</td>
            <td class='text-right'>".number_format($value['PT'],0,","," ")."</td>
            <td class='text-right'>".number_format($value['PRIX_MIS'],0,","," ")."</td>
            <td class='text-right'>".$value['NOM_GROUPE']."</td>
            </tr>";
          }
          $tableliste .= "</tbody></table>";
