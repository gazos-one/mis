...
<input type="hidden" name="YEAR" id="YEAR" value="<?=$YEAR?>">
 ...
 <table id="mytable" class="table table-bordered table-striped table-hover table-responsive">
      ...
      <div class="modal fade" id="apercu_detail" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              ...
              <table id="mytable2" class="table table-bordered table-striped table-hover table-responsive">
                  <thead>
                  <tr>
              <th>Affili&eacute;</th>
              <th>Patient</th>
...
<script type="text/javascript">
   ...
   $("#apercu_detail").modal();
    ...
    $("#mytable2").DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?php echo base_url('consultation/Liste_Medicament_Pharmacie/get_detail');?>",
        type:"POST",
        data:{id:id,ANNEE:ANNEE,STATUS_PAIEMENT:STATUS_PAIEMENT,MOIS:MOIS},
      },
      lengthMenu: [[10,50, 100, row_count], [10,50, 100, "All"]],
      pageLength: 10,
      "columnDefs":[{
