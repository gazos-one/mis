           ...
           <div class="card card-primary">
             ...
             <div class="card-body">
               <!-- <form id="FormData" action="#" method="POST"> -->
                 <form id="FormData" action="<?php echo base_url()?>consultation/Pdf_prise_en_charge/update" method="POST" enctype="multipart/form-data">
                  <div class="row">

                    <input type="hidden" id="ID_PRISE_CHARGE" value="<?= $selected['ID_PRISE_CHARGE']?>" name="ID_PRISE_CHARGE">
                      ...
                      <option value="">-- Sélectionner --</option>
                       ...
                       <?php
                          foreach ($tconsultation as $key => $value) { 
                            if ($selected['ID_CONSULTATION_TYPE'] == $value['ID_CONSULTATION_TYPE']) {
                             ?>
                   ...
                   <select class="form-control" name="ID_TYPE_STRUCTURE" id="ID_TYPE_STRUCTURE" onchange="getstructure(this)">
                    ...
                    <?php
                          foreach ($periode as $key => $value) { 
                            if ($selected['ID_TYPE_STRUCTURE'] == $value['ID_TYPE_STRUCTURE']) {
                             ?>
                ...
                <option value="">-- Sélectionner --</option>
                   ...
                   <?php
                          foreach ($groupe as $key => $value) { 
                            if ($selected['ID_GROUPE'] == $value['ID_GROUPE']) {
                             ?>
