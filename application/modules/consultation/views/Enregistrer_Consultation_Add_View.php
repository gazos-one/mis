      ...
      <div class="container-fluid">
        <div class="row">
         ...
         <div class="card-body">
               ...
               <form id="FormData" action="<?php echo base_url()?>consultation/Enregistrer_Consultation/add" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        <!-- <div class="col-md-12">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text"  max=""  class="form-control" id="NUM_BORDERAUX" name="NUM_BORDERAUX" value="<?=set_value('NUM_BORDERAUX') ?>">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="number"  max=""  class="form-control" id="MONTANT_CONSULTATION" name="MONTANT_CONSULTATION" value="<?=set_value('MONTANT_CONSULTATION') ?>">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text"  max=""  class="form-control" id="POURCENTAGE_C" name="POURCENTAGE_C" value="<?=set_value('POURCENTAGE_C') ?>" readonly="readonly">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text"  max=""  class="form-control" id="POURCENTAGE_A" name="POURCENTAGE_A" value="<?=set_value('POURCENTAGE_A') ?>" onchange="calmontant()">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text"  max=""  class="form-control" id="MONTANT_A_PAYER" name="MONTANT_A_PAYER" value="<?=set_value('MONTANT_A_PAYER') ?>" readonly="readonly">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text"  max=""  class="form-control" id="MEDECIN" name="MEDECIN" value="<?=set_value('MEDECIN') ?>">
...
<script>
     ...
     function getaffilie_by_group(va){
      ...
      $.post('<?php echo base_url('consultation/Enregistrer_Consultation/getaffilie_by_group')?>',
          {ID_GROUPE:ID_GROUPE},
          function(data){
            // alert(data);
