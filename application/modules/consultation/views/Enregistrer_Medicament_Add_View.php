      ...
      <div class="container-fluid">
        <div class="row">
         ...
         <div class="card-body">
               ...
               <form id="FormData" action="<?php echo base_url()?>consultation/Enregistrer_Medicament/add" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        <!-- <div class="col-md-12">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="text"  max=""  class="form-control" id="MONTANT_UNITAIRE_SANS_TAUX" name="MONTANT_UNITAIRE_SANS_TAUX" value="<?=set_value('MONTANT_UNITAIRE_SANS_TAUX') ?>">
                  ...
                  <div class="form-group col-md-1">
                    ...
                    <input type="text"  max=""  class="form-control" id="QUANTITE" name="QUANTITE" value="<?=set_value('QUANTITE') ?>">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="text"  max=""  class="form-control" id="POURCENTAGE" name="POURCENTAGE" value="<?=set_value('POURCENTAGE') ?>">
...
<script>
     ...
     function getpourcentage(){
      ...
      $.post('<?php echo base_url('consultation/Enregistrer_Medicament/getpourcentage')?>',
          {
            ID_MEMBRE:ID_MEMBRE,
