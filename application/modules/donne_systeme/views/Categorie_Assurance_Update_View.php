      ...
      <div class="card card-primary">
              ...
              <form id="FormData" action="<?php echo base_url()?>donne_systeme/Categorie_Assurance/update" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group col-lg-6">
                  ...
                  <div class="form-group col-lg-2">
                    <label for="exampleInputEmail1">Pla. Prothèses dentaires<spam class="text-danger">*</spam> </label>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <input type="number" class="form-control" id="PLAFOND_PHARMACEUTICAL" name="PLAFOND_PHARMACEUTICAL" value="<?php echo $data['PLAFOND_PHARMACEUTICAL']?>">
                    <?php echo form_error('PLAFOND_PHARMACEUTICAL', '<div class="text-danger">', '</div>'); ?>
                  </div>

                  <div class="form-group col-lg-2">
                    <label for="exampleInputEmail1">Plafond Cesarienne<spam class="text-danger">*</spam> </label>
                    <input type="number" class="form-control" id="PLAFOND_CESARIENNE" name="PLAFOND_CESARIENNE" value="<?php echo $data['PLAFOND_CESARIENNE']?>">
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <input type="number" class="form-control" id="PLAFOND_SCANNER" name="PLAFOND_SCANNER" value="<?php echo $data['PLAFOND_SCANNER']?>">
                  ...
                  <div class="form-group col-lg-12">
                    ...
                    <input type="number" class="form-control" id="STRUCT_C" name="STRUCT_C" value="<?php echo $strucc['POURCENTAGE']?>" min="0" max="100">
