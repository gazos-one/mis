...
class Categorie_Assurance  extends CI_Controller{
    ...
    public function index()
    {
      ...
      $resultat=$this->Model->getRequete('SELECT ID_CATEGORIE_ASSURANCE, syst_categorie_assurance.STATUS, IF(syst_categorie_assurance.STATUS=1, "Actif", "Innactif") AS NSTATUS, syst_categorie_assurance.DESCRIPTION AS ADESC, DROIT_AFFILIATION, COTISATION_MENSUELLE, PLAFOND_COUVERTURE_HOSP_JOURS, PLAFOND_ANNUEL, PLAFOND_LUNETTE, PLAFOND_MONTURES, PLAFOND_PROTHESES_DENTAIRES, syst_regime_assurance.DESCRIPTION AS RASSU FROM syst_categorie_assurance JOIN syst_regime_assurance ON syst_regime_assurance.ID_REGIME_ASSURANCE = syst_categorie_assurance.ID_REGIME_ASSURANCE');
      $tabledata=array();
      ...
      foreach ($resultat as $key) 
         {
          ...
          $tabplafond .= '<tr><td>Plafond Annuel</td><td>'.number_format($key['PLAFOND_ANNUEL'],0,","," ").'</td></tr>';
          $tabplafond .= '<tr><td>Plafond hospitalisation</td><td>'.number_format($key['PLAFOND_COUVERTURE_HOSP_JOURS'],0,","," ").'</td></tr>';
          $tabplafond .= '<tr><td>Plafond Lunette médicale</td><td>'.number_format($key['PLAFOND_LUNETTE'],0,","," ").'</td></tr>';
          $tabplafond .= '<tr><td>Plafond Montures</td><td>'.number_format($key['PLAFOND_MONTURES'],0,","," ").'</td></tr>';
          $tabplafond .= '<tr><td>Plafond Prothèses dentaires</td><td>'.number_format($key['PLAFOND_PROTHESES_DENTAIRES'],0,","," ").'</td></tr>';
          $tabplafond .= '</table>';
          ...
          // PLAFOND_ANNUEL PLAFOND_LUNETTE PLAFOND_MONTURES PLAFOND_PROTHESES_DENTAIRES
...
<div class="dropdown">
  ...
  $this->form_validation->set_rules('PLAFOND_ANNUEL', 'Plafonf annuel', 'required');
  $this->form_validation->set_rules('PLAFOND_LUNETTE', 'Plafonf Lunette', 'required');
  $this->form_validation->set_rules('PLAFOND_MONTURES', 'Plafonf Monture', 'required');
  $this->form_validation->set_rules('PLAFOND_PROTHESES_DENTAIRES', 'Plafonf Prothese dentaire', 'required');
  ...
  $this->form_validation->set_rules('COTISATION_MENSUELLE', 'Cotisation Mensuele', 'required');
  $this->form_validation->set_rules('PLAFOND_COUVERTURE_HOSP_JOURS', 'Plafonf couverture', 'required');
  $this->form_validation->set_rules('PLAFOND_ANNUEL', 'Plafonf couverture', 'required');
  $this->form_validation->set_rules('PLAFOND_LUNETTE', 'Plafonf couverture', 'required');
  $this->form_validation->set_rules('PLAFOND_MONTURES', 'Plafonf couverture', 'required');
  $this->form_validation->set_rules('PLAFOND_PROTHESES_DENTAIRES', 'Plafonf couverture', 'required');
  $this->form_validation->set_rules('ID_REGIME_ASSURANCE', 'Regime assurance', 'required');
  $this->form_validation->set_rules('MED_GEN', 'Medicament Generique', 'required');
  $this->form_validation->set_rules('MED_SEP', 'Medicament Specialise', 'required');
  $this->form_validation->set_rules('STRUCT_A', 'Structure A', 'required');
