           ...
           <div class="card card-primary">
              ...
              <div class="card-body">
               <!-- <form id="FormData" action="#" method="POST"> -->
                <form id="FormData" action="<?php echo base_url()?>cotisation/Configuration_Cotisation/update_carte" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-12">
                      <h4>Configuration des cotisations</h4>
                    </div>

                    <input type="hidden" name="ID_COTISATION_CARTES" class="form-control" value="<?=$cotisation['ID_COTISATION_CARTES'] ?>" id="ID_COTISATION" >
