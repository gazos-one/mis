          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Liste adhesion</h3>
              </div>
          ...
          <div class="col-sm-12">
            ...
            <div class="form-group col-md-4">
                <label for="ID_GROUPE">
                          ...
                          <select class="form-control"  onchange="liste2()" name="ID_GROUPE" id="ID_GROUPE">
...
<script>
    ...
    $("#mytable").DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?php echo base_url('cotisation/Gestion_Adhesion/liste2');?>",
        type:"POST",
