                ...
                <form id="FormData" action="<?php echo base_url()?>cotisation/Configuration_Cotisation/update" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-12">
                     ...
                     <input type="hidden" name="ID_COTISATION" class="form-control" value="<?=$cotisation['ID_COTISATION'] ?>" id="ID_COTISATION" >
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <div>
                      <?php if($cotisation['AYANT_DROIT']==1) {?>
                        <label class="radio-inline">
                          <input type="radio" name="AYANT_DROIT" value="1"  checked> Oui
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="AYANT_DROIT" value="2"> Non
                        </label>
