   <div class="content-header">
     ...
     href="<?=base_url('cotisation/Membre_Categorie/')?>">Liste des affilie sans Categorie</a></li>
     <li><a class="btn <?php if($this->router->method == 'groupe') echo 'btn-primary';?> btn-sm" 
     href="<?=base_url('cotisation/Membre_Categorie/groupe')?>">Affilié par groupe</a></li>
     <li><a class="btn <?php if($this->router->method == 'listing') echo 'btn-primary';?> btn-sm" 
     href="<?=base_url('cotisation/Membre_Categorie/listing')?>">Liste des affilie avec Categorie</a></li>
            </ol>
