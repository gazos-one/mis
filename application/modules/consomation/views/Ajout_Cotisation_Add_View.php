          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Enregistrement des cotisations des membres</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="FormData" action="<?php echo base_url()?>cotisation/Ajout_Cotisation/add" method="POST">
              <div class="row">
                       ...
                       <div class="form-group col-md-4">
                          ...
                          <select class="form-control select2" onchange="getMembre()" style="width: 100%;" id="ID_MEMBRE" name="ID_MEMBRE">
                    <option> Selectionner le membre</option>
                    <?php 
                          foreach ($membre as $value) {
                            ?>
                    <option value="<?php echo $value['ID_MEMBRE']?>"><?php echo $value['NOM']?> <?php echo $value['PRENOM']?></option>
                          <?php
                        }
                          ?>
                  </select> 
...
function getMembre(){
  ...
  // alert(ID_MEMBRE);
  $.post('<?php echo base_url('cotisation/Ajout_Cotisation/getMembre')?>',
          {
