  ...
  <div style="width: 830px; height: 490px; border: 0px solid black; margin: auto; padding-top:10px;padding-bottom: 5">
    ...
    <div style="width: 414px; height: 485px; float: left; margin: auto; ">
            ...
            <!-- <div style="width: 418px; height: 490px; float: right; border: 1px solid black;"> -->
              ...
              <div class="text-center" style="width: 110px; height: 140px; float: left; padding-left:20px; margin-top: 3px; ">
                ...
                <div style="width: 300px; height: 143px; float: right; font-size: 14px; ">
                ...
                <div class="text-center" style=" padding-left:20px;width: 110px; height: 140px; float: left;">
                  <!-- <br> -->
                ...
                <div style="width: 301px; height: 140px; float: right; font-size: 14px;">
                  <br><br>
                  <?php 
                ...
                <div class="text-center" style=" padding-left:20px; width: 110px; height: 160px; float: left;">
                 <!-- <br> -->
                 <!-- <img src="<?php echo base_url()?>/uploads/imgayant.png" style="max-height: 50px;  margin-bottom: 0px; margin-top: 0px;  max-width: 1.2cm" > -->
                 <?php
                    ...
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $fourthnimag?>" style="max-height: 150px; max-width: 1.8cm" >
                </div>
                <div style="width: 301px; height: 160px; float: right; font-size: 14px;">
  ...
  <div class="col-md-10" style="width: 21.0cm" id="printsideB">
          ...
          <!-- <div style="width: 840px; height: 490px; border: 1px solid black; margin: auto;">
            ...
            <div style="width: 420px; height: 490px; float: left; border: 1px solid black;">
                ...
                <div style="width: 420px; height: 140px;">
                <div class="text-center" style="width: 110px; height: 140px; float: left;">
                  <img src="<?php echo base_url()?>/uploads/imgayant.png" style="max-height: 50px;  max-width: 1.5cm" >
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $fivenimag?>" style="max-height: 150px; max-width: 2.5cm" >
                </div>

                <div style="width: 308px; height: 140px; float: right; font-size: 16px;">
                  <br>
                  <?php 
                  ...
                  <table>
                    <tr>
                      <td><b>NOM ET PRENOM</b></td>
                      <td>:</td>
                      <td><?php echo $fivehayantdroit['NOM'].' '.$fivehayantdroit['PRENOM']?></td>
                    </tr>
                    <tr>
                      <td><b>GROUPE SANGUIN</b></td>
                      <td>:</td>
                ...
                <div style="width: 420px; height: 140px;">
                <div class="text-center" style="width: 110px; height: 140px; float: left;">
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $sixnimag?>" style="max-height: 150px; max-width: 2.5cm" >
                </div>
                ...
                <div style="width: 308px; height: 140px; float: right; font-size: 16px; ">
                  ...
                  <table>
                    <tr>
                      <td><b>NOM ET PRENOM</b></td>
                      <td>:</td>
                      <td><?php echo $sixhayantdroit['NOM'].' '.$sixhayantdroit['PRENOM']?></td>
                    </tr>
                    <tr>
                      <td><b>GROUPE SANGUIN</b></td>
                      <td>:</td>
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td><?php 
                        $newDates6 = date("d-m-Y", strtotime($sixhayantdroit['DATE_NAISSANCE']));
                        echo  $newDates6;
                      ?></td>
                    </tr>
                  </table>
              ...
              <div style="width: 420px; height: 210px; padding-left: 5px; font-size: 15px;">
                <br><br>
                ...
                <div style="width: 220px; height: 135px; float: right; font-size: 14px;">
                  ...
                  <table>
                    <tr>
                      <td>NOM</td>
                      <td>:</td>
                      <td><b><?php echo $sixhayantdroit['NOM'].' '.$sixhayantdroit['PRENOM']?></b></td>
                    </tr>
                    <tr>
                      <td>G/S.</td>
                      <td>:</td>
