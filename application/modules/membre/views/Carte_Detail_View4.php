            ...
            <div style="width: 414px; height: 485px; float: left; margin: auto; ">
              ...
              <!-- <div style="width: 420px; height: 245px;"> -->
                ...
                <!-- <div style="width: 110px; height: 245px; float: left;"><br> -->
                  ...
                  <!-- <img src="<?php echo base_url()?>/uploads/benemis.png" style="max-height: 50px;  max-width: 1.5cm; margin-bottom: 10px" >   -->
                ...
                <!-- <div style="width: 305px; height: 245px; float: right; font-size: 16px;"> -->
                  ...
                  <table>
                    ...
                    <!-- <tr>
                      <td>CODE</td>
                      <td>:</td>
                      <td><b><?php echo $selected['CODE_AFILIATION']?></b></td>
                    </tr> -->
                    <tr>
            ...
            <!-- <div style="width: 418px; height: 490px; float: right; border: 1px solid black;"> -->
              ...
              <!-- <div style="width: 110px; height: 245px; float: left; ">
                <br><div class="text-center">
                  ...
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $secondnimag?>" style="max-height: 150px; max-width: 2.5cm" >
                  </div>
                ...
                <div style="width: 301px; height: 245px; float: right; font-size: 14px;">
                  ...
                  <table>
                    ...
                    <tr>
                      <td>NAISSANCE</td>
                      <td>:</td>
                      <!-- <td><?php echo $thirdayantdroit['DATE_NAISSANCE']?></td> -->
                      <td><b><?php 
  ...
  <div class="col-md-10" style="width: 21.0cm" id="printsideB">
     ...
     <!--Debut de la 2eme page-->
          <!-- <div style="width: 840px; height: 490px; border: 1px solid black; margin: auto;"> -->
            <div style="width: 830px; height: 490px; border: 0px solid black; margin: auto; padding-top:8px;padding-bottom: 5">

            <!-- <div style="width: 420px; height: 490px; float: left; border: 1px solid black;">
              
              <div style="width: 420px; height: 245px; ">
                <div class="text-center" style="width: 110px; height: 245px; float: left;">
                 <br>
                 <img src="<?php echo base_url()?>/uploads/imgayant.png" style="max-height: 50px;  max-width: 1.5cm" > 
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $fourthnimag?>" style="max-height: 150px; max-width: 2.5cm" >
                </div>

                <div style="width: 308px; height: 245px; float: right; font-size: 16px;">
                  <br><br><br>
                  <?php 
                  ...
                  <table>
                    <tr>
                      ...
                      <td>:</td>
                      <td><?php echo $fourthayantdroit['NOM'].' '.$fourthayantdroit['PRENOM']?></td>
                    </tr>
                    <tr>
                      <td><b>GROUPE SANGUIN:</b></td>
                      <td>:</td>
                      <td><?php echo $FOGSANGUIN['DESCRIPTION'];?></td>
                    </tr>
                    <tr>
            ...
            <div style="width: 419px; height: 245px;  padding-left:70px;">
                <div style="width: 110px; height: 245px; float: left; ">
                  ...
                  <?php
                    ...
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $fourthnimag?>" style="max-height: 140px; max-width: 2.2cm" >  
                  </div>
              ...
              <!-- <div style="width:390px; height: 245px; border: 1px solid blue;">
                <div style="width: 3cm; height: 5cm; float: left; border: 1px solid blue;">
                 
                </div>

               
              </div> -->
              <div style="width: 390px; height: 245px; font-size: 14px; padding-left:100px!important ; padding-top:10px!important " class="text-center">
