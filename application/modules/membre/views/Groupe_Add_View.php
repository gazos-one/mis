    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
           ...
           <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Ajout d'un groupe d'affilié</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->

            <div class="card-body">
             <form id="FormData" action="<?php echo base_url()?>membre/Groupe/add" method="POST">
              <div class="row">
               ...
               <input type="text" name="NOM_GROUPE" class="form-control" value="" id="NOM_GROUPE">
             ...
             <input type="date" name="DATE_ENREGISTREMENT" class="form-control" value="<?php echo date('Y-m-d')?>" id="DATE_ENREGISTREMENT">
           ...
           <input type="text" name="NIF" class="form-control" value="" id="NIF">
         ...
         <input type="text" name="RESIDENCE" class="form-control" value="" id="RESIDENCE">
