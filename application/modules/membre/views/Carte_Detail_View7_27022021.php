...
<?php
               ...
               if ($sixhayantdroit['URL_PHOTO'] == null) {
               ...
               if ($septhayantdroit['URL_PHOTO'] == null) {
...
<!-- <div style="width: 840px; height: 490px; border: 1px solid black; margin: auto;"> -->
  <div style="width: 830px; height: 490px; border: 0px solid black; margin: auto; padding-top:10px;">

    <div style="width: 414px; height: 485px; float: left; margin: auto; border: 0px solid black; ">
                <div style="width: 419px; height: 155px;  padding-left:70px; border: 0px solid black; ">
                  <div class="text-center" style="width: 110px; height: 150px; float: left; margin-top: 3px ; border: 0px solid black;" >
                  <img src="<?php echo base_url()?>/uploads/benefi_image.png" style="max-height: 50px;  max-width: 1.2cm; margin-top: 5px; margin-bottom: 6px; " > 
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $nimag?>" style="max-height: 140px;  max-width: 1.8cm" >
                  
                </div>
                <!-- <div style="width: 305px; height: 245px; float: right; font-size: 16px;"> -->
                  <div style="width: 220px; height: 153px; float: right; font-size: 14px; border: 0px solid black;">
                  <?php 
              ...
              <div style="width: 419px; height: 130px;  padding-left:70px; border: 0px solid green; ">
                <?php
              if (!is_null($firstayantdroit)) {
                ?>
                <div style="width: 110px; height: 130px; float: left; border: 0px solid green; ">
                  ...
                  <?php
                    ...
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $firstnimag?>" style="max-height: 140px; max-width: 1.8cm" >  
                  </div>
                  
                </div>
                <!-- <div style="width: 305px; height: 245px; float: right; font-size: 16px;"> -->
                  <div style="width: 220px; height: 130px; float: right; font-size: 14px; border: 0px solid green;">
              ...
              <div style="width: 419px; height: 130px;  padding-left:70px; border: 0px solid blue; ">
                <?php
              if (!is_null($secondayantdroit)) {
                ?>
                <div style="width: 110px; height: 130px; float: left; border: 0px solid blue; ">
                  <div class="text-center">
                  <?php
                    ...
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $secondnimag?>" style="max-height: 140px;  max-width: 1.8cm" >
                  </div>
                  
                </div>
                  <div style="width: 220px; height: 130px; float: right; font-size: 14px; border: 0px solid blue;">
            ...
            <!-- <div style="width: 418px; height: 490px; float: right; border: 1px solid black;"> -->
              ...
              <div class="text-center" style="width: 105px; height: 140px; float: left; padding-left:15px; margin-top: 3px; ">
                
                  <!-- <img src="<?php echo base_url()?>/uploads/imgayant.png" style="max-height: 50px;  margin-bottom: 0px;  max-width: 1.2cm; margin-top: 5px" > -->
                  <?php
                    ...
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $thirdnimag?>" style="max-height: 140px;  max-width: 1.8cm" >

                </div>

                <div style="width: 309px; height: 143px; float: right; font-size: 14px; padding-right: 30px ">
              ...
              if (!is_null($fourthayantdroit)) {
                ?>
                <div class="text-center" style=" padding-left:15px;width: 105px; height: 140px; float: left;">
                  <!-- <br> -->

                  <!-- <img src="<?php echo base_url()?>/uploads/imgayant.png" style="max-height: 50px;  margin-bottom: 0px; margin-top: 0px;  max-width: 1.2cm" > -->
                  <?php
                ...
                <div style="width: 309px; height: 140px; float: right; font-size: 14px;">
                  <br>
                  <?php 
                ...
                <!--Debut de la 5 eme personne-->
                <?php
              if (!is_null($fivehayantdroit)) {
                ?>
                <div class="text-center" style=" padding-left:15px; width: 105px; height: 160px; float: left;">
                 <?php
                    ...
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $fivenimag?>" style="max-height: 150px; max-width: 1.8cm" >
                </div>
                <div style="width: 309px; height: 160px; float: right; font-size: 14px;">
                ...
                ?>
              <!-- <div style="width: 9.0cm; height: 3cm; ">
                

                
              </div> -->
                <!--Fin de la 5 eme personne-->
...
<input type="button" class="btn btn-primary" onclick="printDiv('printsideB')" value="Imprimer la FACE B" />
  ...
  <div class="col-md-10" style="width: 21.0cm" id="printsideB">
          ...
          <div style="width: 830px; height: 490px;  margin: auto; padding-top:10px;padding-bottom:0">

           
            <div style="width: 414px; height: 485px; float: left; margin: auto; "> 


            <div style="width: 419px; height: 125px;  padding-left:70px;">
              <?php
              if (!is_null($sixhayantdroit)) {
                ?>
                <div style="width: 110px; height: 125px; float: left; ">
                  <div class="text-center">
                  <?php
                    if ($sixhayantdroit['IS_CONJOINT'] == 1) { ?>
                      <img src="<?php echo base_url()?>/uploads/conjoint.png" style="max-height: 50px;  margin-bottom: 0px;  max-width: 1.5cm" >
                      <?php
                    }
                    else{
                      ?>
                      <img src="<?php echo base_url()?>/uploads/imgayant.png" style="max-height: 50px;  margin-bottom: 0px;  max-width: 1.5cm" >
                      <?php
                    }
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $sixnimag?>" style="max-height: 140px; max-width: 1.8cm" >  
                  </div>
                  
                </div>
                <div style="width: 220px; height: 125px; float: right; font-size: 14px;">
              ...
              if (!is_null($septhayantdroit)) {
                ...
                <div style="width: 110px; height: 125px; float: left;">
                  ...
                  <?php
                    ...
                    ?>
                  <img src="<?php echo base_url()?>/uploads/image_membre/<?php echo $septnimag?>" style="max-height: 140px; max-width: 1.8cm" >
                  </div>
              ...
              <div style="width: 390px; height: 180px; font-size: 14px;  padding-left:100px!important ; padding-top:-10px!important " class="text-center">

                
              <table style="border: 2px solid black">
  <tr style="padding: 2px; border: 2px solid black">
    <td colspan="6" class="text-left" style="padding: 0.5px; border: 2px solid black; font-size: 15px;"><b>CODE: <?php echo $categoriecarte['CODE_CARTE']?></b></td>
  </tr>
  <tr style="padding: 2px; border: 2px solid black">
