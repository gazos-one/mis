  ...
  <!-- <div style="width: 830px; height: 490px; border: 0px solid black; margin: auto; padding-top:8px;padding-bottom: 5"> -->
    <div style="width: 830px; height: 490px; border: 0px solid black; margin: auto; padding-top:10px;padding-bottom: 5">
            ...
            <!-- <div style="width: 420px; height: 490px; float: left; border: 1px solid black;"> -->
              ...
              <!-- <div style="width: 414px; height: 245px;  padding-left:70px; "> -->
...
<input type="button" class="btn btn-primary" onclick="printDiv('printsideB')" value="Imprimer la FACE B" />
  ...
  <!-- <tr style="padding: 5px; border: 2px solid black">
    ...
    <td colspan="3" class="text-center" style="border: 2px solid black">Affiliation: <?php echo $categoriecarte['DATE_DABUT_VALIDITE']?></td>

    <td colspan="5" class="text-left" style="border: 2px">Validit&eacute;: <?php echo $categoriecarte['DATE_FIN_VALIDITE']?></td>
