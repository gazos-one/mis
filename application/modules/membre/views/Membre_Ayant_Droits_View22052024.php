              ...
              <form id="FormData" action="<?php echo base_url()?>membre/Membre/ayant_droits_add" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="ID_MEMBRE" class="form-control" value="<?php echo $selected['ID_MEMBRE']?>" id="ID_MEMBRE">
                    ...
                    <label for="">Photo Passport</label>
                     <input type="file" name="URL_PHOTO" value="<?=set_value('URL_PHOTO')?>" required="required" class="form-control" id="URL_PHOTO">
                       ...
                       <div class="form-group col-md-4">
                          ...
                          <!-- <input type="date" name="DATE_NAISSANCE" class="form-control" value="" id="DATE_NAISSANCE"> -->
                          <input type="date" name="DATE_NAISSANCE" class="form-control" value="<?=set_value('DATE_NAISSANCE')?>" id="DATE_NAISSANCE">
                       ...
                       <div class="form-group col-md-4">
                          ...
                          <br>
                          <label class="radio-inline">
                            <input type="radio" name="IS_CONJOINT" value="1"> OUI &nbsp;&nbsp;&nbsp;&nbsp;
                          </label>
                          <label class="radio-inline">
                            <input type="radio" name="IS_CONJOINT" value="0"> NON
                          </label>
                          <!-- <input type="number" name="TELEPHONE" class="form-control" value="" id="TELEPHONE"> -->
