      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modification d'un ayant droit</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
         ...
         <div class="card-body">
               ...
               <form id="FormData" action="<?php echo base_url()?>membre/Membre/update_ayant_droit" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="">Photo Passport</label>
                     <input type="file" name="URL_PHOTO" value="<?=set_value('URL_PHOTO')?>" accept="image/png, image/jpeg" class="form-control" id="URL_PHOTO">
                       ...
                       <div class="form-group col-md-3">
                          ...
                          <input type="date" name="DATE_ADHESION" class="form-control" value="<?php echo $selected['DATE_ADHESION']?>" readonly="readonly" id="DATE_ADHESION">
