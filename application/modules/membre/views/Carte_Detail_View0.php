...
<input type="button" class="btn btn-primary" onclick="printDiv('printsideA')" value="Imprimer la FACE A" />
  ...
  <div class="col-md-10" style="width: 14.8cm"  id="printsideA">

<!-- <div style="width: 700px; height: 490px; border: 1px solid black; margin: auto;"> -->
<div style="width: 830px; height: 490px; border: 0px solid black; margin: auto; padding-top:10px;padding-bottom: 5">
            ...
            <div style="width: 414px; height: 485px; float: left; margin: auto; ">
              ...
              <div style="width: 420px; height: 245px;  padding-left:70px;">
                <div class="text-center" style="width: 110px; height: 245px; float: left; margin-top: 5px " >
                  <!-- <div > -->
                  <img src="<?php echo base_url()?>/uploads/benefi_image.png" style="max-height: 50px;  max-width: 1.5cm; margin-bottom: 10px" >  
                  <!-- </div> -->
                ...
                <div style="width: 240px; height: 245px; float: right; font-size: 14px; ">
                  <?php 
            ...
            <div style="width: 414px; height: 485px; float: right; margin: auto;">
