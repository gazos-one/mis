...
public function addEmploi()
  ...
  public function countmembre()
  {
    ...
    $catego=$this->Model->getRequete("SELECT * FROM syst_categorie_assurance WHERE ID_REGIME_ASSURANCE = ".$ID_REGIME_ASSURANCE." ORDER BY DESCRIPTION");
  ...
  // echo $PROVINCE_ID;exit();
   ...
   if ($this->form_validation->run() == FALSE){
     ...
     public function listing()
    {
      ...
      // echo 'SELECT membre_membre.ID_MEMBRE,CODE_AFILIATION, NOM, PRENOM, CNI, DATE_ADHESION, membre_membre.STATUS, IS_AFFILIE FROM `membre_membre` JOIN membre_groupe_membre ON membre_groupe_membre.ID_MEMBRE = membre_membre.ID_MEMBRE WHERE 1 '.$condi1.' '.$condi2.' '.$condi3.' '.$condi4.' '.$condi5.' '.$condi6.'';
