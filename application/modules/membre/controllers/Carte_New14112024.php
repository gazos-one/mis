...
$order_by = '';
$search = !empty($_POST['search']['value']) ? (" AND (CONCAT(membre_membre.NOM,' ',membre_membre.PRENOM) LIKE '%$var_search%'  OR membre_membre.CNI LIKE '%$var_search%' OR membre_carte.CODE_CARTE LIKE '%$var_search%')") : '';
$order_column='';
