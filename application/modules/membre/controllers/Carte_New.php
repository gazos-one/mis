...
echo json_encode($output);
    ...
    $carte=$this->Model->getRequeteOne('SELECT membre_carte.ID_CARTE, membre_carte.CODE_CARTE, membre_carte.DATE_DABUT_VALIDITE, membre_carte.DATE_FIN_VALIDITE FROM membre_carte JOIN membre_carte_membre ON membre_carte_membre.ID_CARTE = membre_carte.ID_CARTE WHERE membre_carte_membre.ID_MEMBRE = '.$ID_CARTE.' ');

    $result =' <form id="FormDatachange" action="'.base_url().'membre/Carte_New/changedate" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
          ...
          <td>
          <input type="date" class="form-control" id="DEBUT_SUR_LA_CARTE" name="DEBUT_SUR_LA_CARTE" value="'.$carte['DATE_DABUT_VALIDITE'].'" />
          <font color="red" id="erDEBUT_SUR_LA_CARTE"></font>
          </td>
          <td>
          <input type="date" class="form-control" id="FIN_SUR_LA_CARTE" name="FIN_SUR_LA_CARTE" value="'.$carte['DATE_FIN_VALIDITE'].'" />
          <font color="red" id="erFIN_SUR_LA_CARTE"></font>
          <input type="hidden" class="form-control" id="ID_CARTE" name="ID_CARTE" value="'.$carte['ID_CARTE'].'" />
          </td>
          </tr>
          </table>
